...
public class CompilationsServiceImpl implements CompilationsService {
    ...
    public Collection<CompilationDto> findAll(CompilationsPublicGetRequest getRequest) {
        ...
        Page<Compilation> page = compRepository.findAllByPinned(
                getRequest.pinned(),
                getRequest.getPageable()
        );
    ...
    public CompilationDto save(NewCompilationDto newCompilationDto) {
        ...
        Compilation compilation = CompilationsMapper.mapToEntity(
                newCompilationDto,
                events
        );
    ...
    private Map<Long, Long> getViews(Set<Event> events) {
        ...
        return statsClient.getViews(eventIds);
    }
}
